...
pub fn align_of(ty: &Type) -> usize {
    match ty {
        Type::Bool => 1,
        Type::Char => 4,
        Type::Imm(..) | Type::Box(..) | Type::Mut(..) | Type::UniquePointer => ADDR_SIZE,
...
pub fn size_of(ty: &Type) -> usize {
    match ty {
        ...
        Type::Int => 8,
        Type::Char => 4,
        Type::Box(_) | Type::Imm(..) | Type::Mut(..) | Type::UniquePointer => ADDR_SIZE,
...
pub fn encode(e: Endianess, ty: &Type, value: Value) -> Vec<Byte> {
    match ty {
        ...
        Type::Box(_) | Type::Imm(..) | Type::Mut(..) | Type::UniquePointer => {
